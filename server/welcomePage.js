export const sendEmail = (name, age, education, email, phone) =>
  (`<!DOCTYPE html>
<html lang="en">
  <head>
        ...
        <td class="container">
          <div class="content">
            ...
            <span class="preheader"
              >Thank you for registering with us!</span
            >
            <table
              role="presentation"
              border="0"
            ...
            >
              ...
              <tr>
                <td class="wrapper">
                  ...
                  <p style="margin: 5px 0px 0px;"><em>Your Submitted Information</em></p>
                  <ul>  
                    <li>Age: <strong>${age}</strong></li>
                    <li>name: <strong>${name}</strong></li>
                    <li>Phone Number: <strong>${phone}</strong></li>
                    <li>Educational Level: <strong>${education}</strong></li>
              ...
              >
                ...
                <tr>
                  <td class="content-block powered-by">
                    Brought to you by
                    <a href="https://gep-frontend.vercel.app"><strong>HMYC Digital Team</strong></a>
                  </td>
                </tr>
              </table>
            </div>
