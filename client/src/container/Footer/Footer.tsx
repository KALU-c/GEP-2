  ...
  return (
    <footer>
      <div className="row align-items-center">
        ...
        <div className="col-md-2 col-12 text-center text-md-end fs-4 socials d-flex">
          <BsFacebook className="item" /> <BsTelegram className="item" /> <BsTiktok className="item" />
        </div>
      </div>
      <div className="row">
